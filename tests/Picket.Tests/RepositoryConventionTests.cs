...
public sealed partial class RepositoryConventionTests
{
    ...
    public void CiPipelinesEnforceNativeAotSizeBudget()
    {
        ...
        Assert.Contains("dotsider-version: v0.24.7", githubWorkflow);
        ...
        Assert.Contains("dotsiderVersion: v0.24.7", azurePipeline);
        ...
        Assert.Contains("Dotsider CLI to `v0.24.7`", documentation);
