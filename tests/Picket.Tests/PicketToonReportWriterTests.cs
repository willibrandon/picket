...
public sealed class PicketToonReportWriterTests
{
    ...
    public void WriteUsesTabularNativeReportShape()
    {
        ...
        Assert.Contains($"  picket.finding.v1,rule,desc,stdin,\"\",1,2,3,4,line containing secret,secret,2bb80d537b1da3e38bd30361aa855686bde0eacd7162fef6a25fe97bf527a25b,307aa91418c6be9b60a0de3bd843a2e3f206061b0674fc6171ad91025f1c0cb3,{BlobSha256},base64,line containing secret,\"\",2.5,", toon);
        ...
        Assert.Contains("rules[1]{id,description,pattern,pathPattern,secretGroup,entropy,randomnessThreshold,severity,confidence,rulePack,provider,documentationUrl,skipReport}:\n  rule,desc,\"token-[0-9]+\",src/.*,1,3.5,0,high,medium,picket-strict,example,\"https://example.invalid/rules/rule\",true", toon);
