...
internal sealed partial class DocumentationGenerator(string repositoryRoot)
{
    ...
    private readonly string[] _publicPackageIds = ["Picket.Compat", "Picket.Engine", "Picket.Report", "Picket.Rules", "Picket.Security"];
    ...
    internal void Generate()
    {
        ...
        GenerateReleaseProfileReference(referenceRoot);
