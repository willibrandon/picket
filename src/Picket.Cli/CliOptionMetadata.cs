...
internal static class CliOptionMetadata
{
    ...
    internal static string GetOptionDescription(string command, string option)
    {
        ...
        return key switch
        {
            ...
            "--gitlab-include-issues" => "Include GitLab issue bodies and comments in native source enumeration.",
            "--gitlab-include-packages" => "Include GitLab generic package files in native source enumeration.",
            "--gitlab-include-release-assets" => "Include linked GitLab release assets in native source enumeration.",
            "--gitlab-include-releases" => "Include GitLab release descriptions in native source enumeration.",
            ...
            "--gitlab-issue-state" => "Limit GitLab issue enumeration to all, opened, or closed issues; also enables issue scanning.",
            ...
            "--huggingface-bucket" => "Scan this Hugging Face storage bucket.",
            "--huggingface-bucket-prefix" => "Limit Hugging Face bucket enumeration to objects under this prefix.",
            "--huggingface-dataset" => "Scan this Hugging Face dataset repository.",
            "--huggingface-endpoint" => "Use this Hugging Face Hub endpoint for native source enumeration.",
            "--huggingface-include-discussions" => "Include Hugging Face repository discussions.",
            "--huggingface-model" => "Scan this Hugging Face model repository.",
            "--huggingface-pull-request" => "Scan this Hugging Face pull request.",
            "--huggingface-ref" => "Scan this Hugging Face branch, tag, or commit.",
            "--huggingface-space" => "Scan this Hugging Face Space repository.",
            "--huggingface-token-env" => "Read the Hugging Face user access token from this environment variable.",
