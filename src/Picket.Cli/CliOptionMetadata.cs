...
internal static class CliOptionMetadata
{
    ...
    internal static string GetOptionDescription(string command, string option)
    {
        ...
        return key switch
        {
            ...
            "--gitea-generic-package-file" => "Scan this exact Gitea generic package file.",
            "--gitea-generic-package-name" => "Scan this Gitea generic package name.",
            "--gitea-generic-package-owner" => "Scan a Gitea generic package owned by this user or organization.",
            "--gitea-generic-package-version" => "Scan this Gitea generic package version.",
