...
internal static partial class Program
{
    static void WriteHelp()
    {
        ...
        Console.Out.WriteLine("  picket scan [path] [-c path] [-f json|jsonl|csv|junit|html|gitlab|sarif|toon] [-r path]... [--profile picket] [--source path] [--ignore-path path] [--no-ignore] [--cache-dir path] [--cache-mode raw|secret-hash-only] [--enable-rule id] [--verify] [--github-api-endpoint uri] [--github-api-proxy uri] [--live-tls-mode system|tls12-plus] [--live-rate-limit-ms n] [--live-provider-rate-limit-ms n] [--allow-non-public-endpoints] [--github-repository owner/name] [--github-token-env name] [--github-ref ref] [--github-source-api-endpoint uri] [--azure-devops-organization org] [--azure-devops-endpoint uri] [--azure-devops-token-env name] [--azure-devops-token-kind pat|bearer] [--azure-devops-project name] [--azure-devops-repository name] [--azure-devops-branch name] [--allow-non-public-source-endpoints] [--allow-insecure-source-endpoints] [--results value] [--only-verified] [--max-target-megabytes n] [--max-archive-depth n] [--max-archive-entries n] [--max-archive-megabytes n] [--max-archive-ratio n] [--timeout n] [--diagnostics mode[,mode]] [--diagnostics-dir path]");
    ...
    static void WriteScanHelp()
    {
        ...
        Console.Out.WriteLine();
        Console.Out.WriteLine("Usage:");
        Console.Out.WriteLine("  picket scan [path] [-c path] [-f json|jsonl|csv|junit|html|gitlab|sarif|toon] [-r path]... [--profile picket] [--source path] [--ignore-path path] [--no-ignore] [--cache-dir path] [--cache-mode raw|secret-hash-only] [--enable-rule id] [--verify] [--github-api-endpoint uri] [--github-api-proxy uri] [--live-tls-mode system|tls12-plus] [--live-rate-limit-ms n] [--live-provider-rate-limit-ms n] [--allow-non-public-endpoints] [--github-repository owner/name] [--github-token-env name] [--github-ref ref] [--github-source-api-endpoint uri] [--azure-devops-organization org] [--azure-devops-endpoint uri] [--azure-devops-token-env name] [--azure-devops-token-kind pat|bearer] [--azure-devops-project name] [--azure-devops-repository name] [--azure-devops-branch name] [--allow-non-public-source-endpoints] [--allow-insecure-source-endpoints] [--results unknown|structurally-valid|test-credential|invalid|active|inactive|skipped|error] [--only-verified] [--max-target-megabytes n] [--max-archive-depth n] [--max-archive-entries n] [--max-archive-megabytes n] [--max-archive-ratio n] [--timeout n] [--diagnostics mode[,mode]] [--diagnostics-dir path]");
    }
