...
internal static partial class Program
{
    ...
    static void WriteVerifyHelp()
    {
        ...
        Console.Out.WriteLine();
        Console.Out.WriteLine("Usage:");
        Console.Out.WriteLine("  picket verify [path] [-c path] [-f json|jsonl|csv|junit|html|gitlab|sarif|toon] [-r path] [--profile picket] [--source path] [--cache-dir path] [--cache-mode raw|secret-hash-only] [--offline|--live] [--github-api-endpoint uri] [--github-api-proxy uri] [--live-rate-limit-ms n] [--live-provider-rate-limit-ms n] [--allow-non-public-endpoints] [--results unknown|structurally-valid|test-credential|invalid|active|inactive|skipped|error] [--only-verified] [--max-archive-depth n] [--max-archive-entries n] [--max-archive-megabytes n] [--max-archive-ratio n] [--timeout n] [--diagnostics mode[,mode]] [--diagnostics-dir path]");
    }
