...
internal static partial class Program
{
    static void WriteHelp()
    {
        ...
        Console.Out.WriteLine("  picket scan [path] [-c path] [-f json|jsonl|csv|junit|html|gitlab|sarif|toon] [-r path]... [--profile picket] [--source path] [--ignore-path path] [--no-ignore] [--cache-dir path] [--enable-rule id] [--verify] [--github-api-endpoint uri] [--allow-non-public-endpoints] [--max-target-megabytes n] [--max-archive-depth n] [--max-archive-entries n] [--max-archive-megabytes n] [--max-archive-ratio n] [--timeout n] [--diagnostics mode[,mode]] [--diagnostics-dir path]");
        ...
        Console.Out.WriteLine("  picket analyze [path] [-c path] [-f json|jsonl|text] [-r path] [--profile picket] [--source path] [--cache-dir path] [--offline|--live] [--github-api-endpoint uri] [--allow-non-public-endpoints] [--results value] [--max-archive-depth n] [--max-archive-entries n] [--max-archive-megabytes n] [--max-archive-ratio n] [--timeout n] [--diagnostics mode[,mode]] [--diagnostics-dir path]");
        ...
        Console.Out.WriteLine("  picket cache export [source] --cache-dir path --output path [-c path] [--max-decode-depth n] [--max-target-megabytes n] [--ignore-gitleaks-allow]");
        Console.Out.WriteLine("  picket cache import [source] --cache-dir path --input path [-c path] [--max-decode-depth n] [--max-target-megabytes n] [--ignore-gitleaks-allow]");
    ...
    static void WriteAnalyzeHelp()
    {
        ...
        Console.Out.WriteLine();
        Console.Out.WriteLine("Usage:");
        Console.Out.WriteLine("  picket analyze [path] [-c path] [-f json|jsonl|text] [-r path] [--profile picket] [--source path] [--cache-dir path] [--offline|--live] [--github-api-endpoint uri] [--allow-non-public-endpoints] [--results unknown|structurally-valid|test-credential|invalid|active|inactive|skipped|error] [--max-archive-depth n] [--max-archive-entries n] [--max-archive-megabytes n] [--max-archive-ratio n] [--timeout n] [--diagnostics mode[,mode]] [--diagnostics-dir path]");
    }
