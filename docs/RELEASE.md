...
- `ghcr.io/willibrandon/picket:<release-tag>`, for example `v0.1.13`,
- `ghcr.io/willibrandon/picket:<semver>`, for example `0.1.13`,
...
```powershell
dotnet run --file ./scripts/Generate-PackageManagerManifests.cs -- -ReleaseTag v0.1.13 -ChecksumsPath dist/checksums.txt -OutputDirectory artifacts/package-managers -Clean
```
