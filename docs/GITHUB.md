...
The current scope is single-repository file enumeration, repository pull request head enumeration, and organization repository discovery. User repository discovery, issues, gists, releases, Actions artifacts, packages, and code-search-backed discovery remain planned explicit opt-ins.
