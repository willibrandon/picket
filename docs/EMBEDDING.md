...
```xml
<ItemGroup>
  <PackageReference Include="Picket.Compat" Version="0.2.5" />
  <PackageReference Include="Picket.Engine" Version="0.2.5" />
  <PackageReference Include="Picket.Report" Version="0.2.5" />
  <PackageReference Include="Picket.Rules" Version="0.2.5" />
  <PackageReference Include="Picket.Security" Version="0.2.5" />
</ItemGroup>
```
